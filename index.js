  ...
  return (function e(t, n, r) {
  ...
  })(
    {
      1: [
            ...
            (r.prototype._notify = function () {
              ...
              if (e._reading && 0 !== e._missing) {
                if (!e._torrent.bitfield.get(e._piece))
                  return e._torrent.critical(
                    e._piece,
                    e._piece + e._criticalLength
                  );
                if (!e._notifying) {
                  e._notifying = !0;
                  var t = e._piece;
                  e._torrent.store.get(t, function (n, r) {
                    if (((e._notifying = !1), !e.destroyed)) {
                      ...
                      o(
                        ...
                        e._offset &&
                          ((r = r.slice(e._offset)), (e._offset = 0)),
        ...
        { debug: 30, inherits: 41, "readable-stream": 82 },
      ],
      2: [
        function (e, t, n) {
          (function (n) {
            ...
            a(r, i),
              Object.defineProperty(r.prototype, "downloaded", {
                get: function () {
                  if (!this._torrent.bitfield) return 0;
                  for (
                    var e = 0, t = this._startPiece;
                    t <= this._endPiece;
                    ++t
                  )
                    if (this._torrent.bitfield.get(t))
                      e += this._torrent.pieceLength;
                    else {
          ...
          (n.createWebRTCPeer = function (e, t) {
            ...
            (r.prototype.onHandshake = function (e, t) {
              ...
              if (n.swarm && !n.destroyed) {
                ...
                var r = n.addr;
                !r &&
                  n.conn.remoteAddress &&
                  (r = n.conn.remoteAddress + ":" + n.conn.remotePort),
                  n.swarm._onWire(n.wire, r),
                  n.swarm &&
                    !n.swarm.destroyed &&
                    (n.sentHandshake || n.handshake());
              }
            }),
            ...
            (r.prototype.startConnectTimeout = function () {
              var e = this;
              clearTimeout(e.connectTimeout),
                (e.connectTimeout = setTimeout(
                  function () {
                    e.destroy(new Error("connect timeout"));
                  },
                  "webrtc" === e.type ? 25e3 : 5e3
                )),
        ...
        function (e, t, n) {
          ...
          (t.exports = r),
            ...
            (r.prototype.recalculate = function () {
              ...
              for (e = 0; e < t; ++e)
                for (
                  var n = this._torrent.wires[e], r = 0;
                  r < this._numPieces;
                  ++r
                )
        ...
        function (e, t, n) {
          (function (n, r) {
            ...
            try {
              ...
              c = C.join(
                "function" == typeof S.tmpdir ? S.tmpdir() : "/",
                "webtorrent"
              );
            }
            E(o, m),
                ...
                get: function () {
                  ...
                  for (var e = 0, t = 0, n = this.pieces.length; t < n; ++t)
                    if (this.bitfield.get(t))
                      e +=
                        t === n - 1 ? this.lastPieceLength : this.pieceLength;
                    else {
                      var r = this.pieces[t];
              ...
              (o.prototype._onTorrentId = function (e) {
                ...
                if (!t.destroyed) {
                  ...
                  r
                    ? ((t.infoHash = r.infoHash),
                      (t._debugId = r.infoHash.toString("hex").substring(0, 7)),
                      n.nextTick(function () {
              ...
              (o.prototype._onParsedTorrent = function (e) {
                ...
                if (!t.destroyed) {
                  ...
                  t.path || (t.path = C.join(c, t.infoHash)),
                    ...
                    t.destroyed ||
                      (t.emit("infoHash", t.infoHash),
                      t.destroyed ||
                        (t.client.listening
                          ? t._onListening()
                          : t.client.once("listening", function () {
                              t._onListening();
                            })));
                }
              }),
                  ...
                  s &&
                    (s = g(i.client.tracker, {
                      getAnnounceOpts: function () {
                        ...
                        return (
                          i.client.tracker.getAnnounceOpts &&
                            y(e, i.client.tracker.getAnnounceOpts()),
              ...
              (o.prototype._getMetadataFromServer = function () {
                function e(e, n) {
                    ...
                    return s
                      ? s.infoHash !== t.infoHash
                        ? (t.emit(
                            "warning",
                            new Error(
                              "got torrent file with incorrect info hash from xs param: " +
                                e
                            )
                          ),
                          n(null))
                        : (t._onMetadata(s), void n(null))
                      : (t.emit(
                          "warning",
                          new Error(
                  ...
                  var o,
                    i = { url: e, method: "GET", headers: { "user-agent": G } };
                  try {
                    o = b.concat(i, r);
                  } catch (r) {
                    return (
              ...
              (o.prototype._onMetadata = function (e) {
                ...
                if (!t.metadata && !t.destroyed) {
                  ...
                  t._processParsedTorrent(n),
                    ...
                    t.client.enableWebSeeds &&
                      t.urlList.forEach(function (e) {
                        t.addWebSeed(e);
                      }),
                    0 !== t.pieces.length &&
                      t.select(0, t.pieces.length - 1, !1),
                    (t._rarityMap = new q(t)),
                    (t.store = new w(
                      new t._store(t.pieceLength, {
                    ...
                    t._fileModtimes && t._store === v
                      ? t.getFileModtimes(function (e, n) {
              ...
              (o.prototype._destroy = function (e, t) {
                ...
                if (!n.destroyed) {
                  ...
                  n.discovery &&
                    ...
                    I(o, t),
                    e &&
                      (0 === n.listenerCount("error")
                        ? n.client.emit("error", e)
                        : n.emit("error", e)),
                    n.emit("close"),
                    (n.client = null),
                    (n.files = []),
                ...
                if (t.client.blocked) {
                  ...
                  if ("string" == typeof e) {
                    ...
                    try {
                      ...
                      return (
                        t._debug("ignoring peer: invalid %s", e),
                  ...
                  if (n && t.client.blocked.contains(n))
                    return (
                      t._debug("ignoring peer: blocked %s", e),
              ...
              (o.prototype._addPeer = function (e) {
                ...
                if (t._peers[n])
                  return (
                    t._debug("ignoring peer: duplicate (%s)", n),
                    "string" != typeof e && e.destroy(),
                    null
                  );
                if (t.paused)
                  return (
                    t._debug("ignoring peer: torrent is paused"),
                    "string" != typeof e && e.destroy(),
                    null
                  );
                ...
                return (
                  ...
                  (t._peers[r.id] = r),
                  (t._peersLength += 1),
                  "string" == typeof e && (t._queue.push(r), t._drain()),
                  r
                );
              }),
              ...
              (o.prototype._onWire = function (e, t) {
                var r = this;
                if (
                  (r._debug("got wire %s (%s)", e._debugId, t || "Unknown"),
                ...
                r.client.dht &&
                  r.client.dht.listening &&
                  e.on("port", function (n) {
                    if (!r.destroyed && !r.client.dht.destroyed) {
                      if (!e.remoteAddress)
                        return r._debug(
                          "ignoring PORT from peer with no address"
                        );
                      if (0 === n || n > 65536)
                  ...
                  r.metadata ||
                    (e.ut_metadata.on("metadata", function (e) {
                  ...
                  "function" != typeof j ||
                    ...
                    e.ut_pex.on("peer", function (e) {
                      r.done ||
                        (r._debug("ut_pex: got peer: %s (from %s)", e, t),
                        r.addPeer(e));
                    }),
                    e.ut_pex.on("dropped", function (e) {
                      ...
                      n &&
                        !n.connected &&
                        (r._debug("ut_pex: dropped peer: %s (from %s)", e, t),
                        r.removePeer(e));
                    }),
              ...
              (o.prototype._onWireWithMetadata = function (e) {
                function t() {
                  o.destroyed ||
                    e.destroyed ||
                    (o._numQueued > 2 * (o._numConns - o.numPeers) &&
                    e.amInterested
                      ? e.destroy()
                      : ((i = setTimeout(t, W)), i.unref && i.unref()));
                }
                function n() {
                ...
                e.on("bitfield", function () {
                  ...
                  e.on("request", function (t, n, r, i) {
                    ...
                    o.pieces[t] || o.store.get(t, { offset: n, length: r }, i);
                  }),
                  e.bitfield(o.bitfield),
                  e.interested(),
                  e.peerExtensions.dht &&
                    o.client.dht &&
                    o.client.dht.listening &&
                    e.port(o.client.dht.address().port),
                  "webSeed" !== e.type &&
                    ((i = setTimeout(t, W)), i.unref && i.unref()),
                  (e.isSeeder = !1),
                  n();
              ...
              (o.prototype._gcSelections = function () {
                for (var e = this, t = 0; t < e._selections.length; ++t) {
                  for (
                    var n = e._selections[t], r = n.offset;
                    e.bitfield.get(n.from + n.offset) &&
                    n.from + n.offset < n.to;

                  )
                    n.offset += 1;
                  r !== n.offset && n.notify(),
                    n.to === n.from + n.offset &&
                      e.bitfield.get(n.from + n.offset) &&
                      (e._selections.splice(t, 1),
                      (t -= 1),
                      n.notify(),
                      e._updateInterest());
                }
              ...
              (o.prototype._update = function () {
                var e = this;
                if (!e.destroyed)
                  for (var t, n = U(e.wires); (t = n()); ) e._updateWire(t);
              }),
              (o.prototype._updateWire = function (e) {
                ...
                function r(e) {
                  for (
                    var t = e, n = e;
                    n < s._selections.length && s._selections[n].priority;
                    n++
                  )
                    t = n;
                ...
                function o(o) {
                  ...
                  for (var i = n(), a = 0; a < s._selections.length; a++) {
                    ...
                    if ("rarest" === s.strategy)
                      for (
                        var d = f.from + f.offset,
                          h = f.to,
                          l = h - d + 1,
                          p = {},
                          m = 0,
                          g = t(d, h, p, i);
                        m < l && !((c = s._rarityMap.getRarestPiece(g)) < 0);

                      ) {
                        for (; s._request(e, c, s._critical[c] || o); );
                        if (!(e.requests.length < u))
                          return f.priority && r(a), !0;
                        (p[c] = !0), m++;
                      }
                    else
                          ...
                          if ("rarest" === s.strategy)
                            for (
                              var i = o.from + o.offset,
                                ...
                                d = t(i, a, c);
                              f < u &&
                              !((r = s._rarityMap.getRarestPiece(d)) < 0);
                            ...
                            for (r = o.to; r >= o.from + o.offset; --r)
                              if (e.peerPieces.get(r) && s._request(e, r, !1))
                                return;
                        }
                    })();
                  var a = i(e, 0.5);
              ...
              (o.prototype._rechoke = function () {
                ...
                var t = this;
                if (t.ready) {
                  t._rechokeOptimisticTime > 0
                    ? (t._rechokeOptimisticTime -= 1)
                    : (t._rechokeOptimisticWire = null);
                  var n = [];
                  t.wires.forEach(function (e) {
                    e.isSeeder ||
                      e === t._rechokeOptimisticWire ||
                      n.push({
                        wire: e,
                  ...
                  for (
                    var r = 0, o = 0;
                    o < n.length && r < t._rechokeNumSlots;
                    ++o
                  )
                    (n[o].isChoked = !1), n[o].wire.peerInterested && (r += 1);
                  if (
                    !t._rechokeOptimisticWire &&
                    o < n.length &&
                    t._rechokeNumSlots
                  ) {
              ...
              (o.prototype._hotswap = function (e, t) {
                ...
                for (s = 0; s < i.requests.length; s++) {
                  var f = i.requests[s];
                  f.piece === t &&
                    n.pieces[t].cancel((f.offset / T.BLOCK_LENGTH) | 0);
                }
              ...
              (o.prototype._request = function (e, t, r) {
                ...
                if (
                  u >=
                  (c
                    ? Math.min(s(e, 1, a.pieceLength), a.maxWebConns)
                    : i(e, 1))
                )
                  return !1;
                var f = a.pieces[t],
                ...
                return (
                  e.request(t, p, m, function n(r, i) {
                    if (!a.destroyed) {
                      if (!a.ready)
                        return a.once("ready", function () {
                          n(r, i);
                        });
                      if ((h[l] === e && (h[l] = null), f !== a.pieces[t]))
                        return o();
                      if (r)
                        return (
                          a._debug(
                          ...
                          c ? f.cancelRemaining(d) : f.cancel(d),
                          void o()
                        );
                      if (
                        (a._debug(
              ...
              (o.prototype._drain = function () {
                ...
                if (
                  ...
                  !(
                    "function" != typeof x.connect ||
                    e.destroyed ||
                    e.paused ||
                    e._numConns >= e.client.maxConns
                  ))
                ) {
                  this._debug(
                  ...
                  if (t) {
                    ...
                    o.once("connect", function () {
                      ...
                      o.on("close", function () {
                        if (!e.destroyed) {
                          if (t.retries >= F.length)
                            return void e._debug(
          ...
          u(r, f),
              ...
              e.setKeepAlive(!0),
                e.once("handshake", function (t, n) {
                  if (!e.destroyed) {
                    ...
                    for (
                      var r = e._torrent.pieces.length, i = new o(r), s = 0;
                      s <= r;
                      s++
                    )
                      i.set(s, !0);
            ...
            (r.prototype.httpRequest = function (e, t, n, r) {
              var o,
                ...
                h = f + n - 1,
                l = u._torrent.files;
              if (l.length <= 1) o = [{ url: u.url, start: f, end: h }];
              else {
              ...
              o.length > 1 && (m = i.alloc(n)),
                o.forEach(function (i) {
                  function u(e, t) {
                    ...
                    s("Got data of length %d", t.length),
                      1 === o.length
                        ? r(null, t)
                        : (t.copy(m, i.fileOffsetInRange),
                          ++g === o.length && r(null, m));
                  }
                  var c = i.url,
                    f = i.start,
                  ...
                  var l = {
                    ...
                    headers: {
                      "user-agent":
                        "WebTorrent/" + d + " (https://webtorrent.io)",
                      range: "bytes=" + f + "-" + h,
                    },
                  };
        ...
        function (e, t, n) {
          ...
          function i(e) {
            ...
            return (
              2 === s
                ? ((i =
                    (f[e.charCodeAt(t)] << 2) | (f[e.charCodeAt(t + 1)] >> 4)),
                  (a[c++] = 255 & i))
                : 1 === s &&
                  ((i =
                    (f[e.charCodeAt(t)] << 10) |
          ...
          function u(e) {
            for (
              var t, n = e.length, r = n % 3, o = "", i = [], s = 0, u = n - r;
              s < u;
              s += 16383
            )
          ...
          (function (e) {
            ...
            function r(t, n, o, i) {
              return null == t || 0 === t.length
                ? null
                : ("number" != typeof n && null == i && ((i = n), (n = void 0)),
                  "number" != typeof o && null == i && ((i = o), (o = void 0)),
                  (r.position = 0),
                  (r.encoding = i || null),
                  (r.data = e.isBuffer(t) ? t.slice(n, o) : new e(t)),
            ...
            (r.bytes = 0),
              ...
              (r.find = function (e) {
                for (
                  var t = r.position, n = r.data.length, o = r.data;
                  t < n;
          ...
          (function (e) {
            ...
            (n.bytes = -1),
              ...
              (n._encode = function (t, r) {
                if (e.isBuffer(r))
                  return t.push(new e(r.length + ":")), void t.push(r);
                if (null != r)
                  switch (typeof r) {
                    case "string":
                      n.buffer(t, r);
            ...
            (n.buffer = function (t, n) {
              ...
              (n.dict = function (e, t) {
                e.push(o);
                for (
                  var i, s = 0, a = Object.keys(t).sort(), u = a.length;
                  s < u;
                  s++
                )
                  (i = a[s]),
                    null != t[i] && (n.buffer(e, i), n._encode(e, t[i]));
                e.push(r);
              }),
              (n.list = function (e, t) {
                var o = 0,
                  s = t.length;
                for (e.push(i); o < s; o++) null != t[o] && n._encode(e, t[o]);
                e.push(r);
              }),
              (t.exports = n);
          }.call(this, e("buffer").Buffer));
          ...
          (function (e) {
            function n(e, t) {
              ...
              0 === arguments.length && (e = 0),
                (this.grow =
                  (t && ((isFinite(t.grow) && r(t.grow)) || t.grow)) || 0),
                ("number" != typeof e && void 0 !== e) ||
                  ((e = new o(r(e))), e.fill && !e._isBuffer && e.fill(0)),
                (this.buffer = e);
            }
            function r(e) {
              var t = e >> 3;
      ...
      14: [
        function (e, t, n) {
          ...
          function o() {
            ...
            m.Duplex.call(this),
              (this._debugId = l(4).toString("hex")),
              ...
              (this.peerPieces = new u(0, { grow: g })),
              (this.peerExtensions = {}),
              (this.requests = []),
              (this.peerRequests = []),
          ...
          h(o, m.Duplex),
            (o.prototype.setKeepAlive = function (e) {
              ...
              t._debug("setKeepAlive %s", e),
                ...
                !1 !== e &&
                  (t._keepAliveInterval = setInterval(function () {
                    t.keepAlive();
                  }, 55e3));
            }),
            ...
            (o.prototype.end = function () {
              this._debug("end"),
                ...
                this._onChoke(),
                m.Duplex.prototype.end.apply(this, arguments);
            }),
            ...
            (o.prototype.handshake = function (e, t, n) {
              ...
              if (
                ("string" == typeof e
                  ? (r = c.from(e, "hex"))
                  : ((r = e), (e = r.toString("hex"))),
                "string" == typeof t
                  ? (o = c.from(t, "hex"))
                  : ((o = t), (t = o.toString("hex"))),
            ...
            (o.prototype.unchoke = function () {
              this.amChoking &&
                ((this.amChoking = !1), this._debug("unchoke"), this._push(b));
            }),
            ...
            (o.prototype.request = function (e, t, n, o) {
              return (
                o || (o = function () {}),
                this._finished
                  ? o(new Error("wire is closed"))
                  : this.peerChoking
                  ? o(new Error("peer is choking"))
                  : (this._debug(
            ...
            (o.prototype._onExtended = function (e, t) {
              if (0 === e) {
                ...
                for (r in this._ext)
                  this.peerExtendedMapping[r] &&
                    this._ext[r].onExtendedHandshake(
                      this.peerExtendedHandshake
                    );
              ...
              for (
                ...
                var r =
                  1 === this._buffer.length
                    ? this._buffer[0]
                    : c.concat(this._buffer);
                (this._bufferSize -= this._parserSize),
                  (this._buffer = this._bufferSize
                    ? [r.slice(this._parserSize)]
                    : []),
            ...
            (o.prototype._parseHandshake = function () {
              ...
              e._parse(1, function (t) {
                ...
                e._parse(n + 48, function (t) {
                  var r = t.slice(0, n);
                  if ("BitTorrent protocol" !== r.toString())
                    return (
                      e._debug(
          ...
          (function (n) {
            function r(e) {
              ...
              (a.peerId =
                ...
                (a._userAgent = e.userAgent),
                (a._wrtc = "function" == typeof e.wrtc ? e.wrtc() : e.wrtc);
              var u =
              ...
              a._trackers = u
                .map(function (e) {
                  ...
                  return ("http:" !== n && "https:" !== n) ||
                    "function" != typeof m
                    ? "udp:" === n && "function" == typeof g
                      ? new g(a, e)
                      : ("ws:" !== n && "wss:" !== n) || !c
                      ? (t(new Error("Unsupported tracker protocol: " + e)),
                        null)
                      : "ws:" === n &&
                        "undefined" != typeof window &&
              ...
              (r.scrape = function (e, t) {
                ...
                return (
                  ...
                  (e.infoHash = Array.isArray(e.infoHash)
                    ? e.infoHash.map(function (e) {
                        return o.from(e, "hex");
                      })
                    : o.from(e.infoHash, "hex")),
                  i.scrape({ infoHash: e.infoHash }),
                  i
                );
              }),
          ...
          a(r, h),
            ...
            (r.prototype.announce = function (e) {
              ...
              if (!t.destroyed && !t.reconnecting) {
                ...
                if (
                  (t._trackerId && (n.trackerid = t._trackerId),
                ...
                var n =
                    Array.isArray(e.infoHash) && e.infoHash.length > 0
                      ...
                      : (e.infoHash && e.infoHash.toString("binary")) ||
                        t.client._infoHashBinary,
                  r = { action: "scrape", info_hash: n };
                t._send(r);
              }
            }),
            (r.prototype.destroy = function (e) {
              ...
              if (
                ((n.peers = null),
                n.socket &&
                  (n.socket.removeListener("connect", n._onSocketConnectBound),
                  n.socket.removeListener("data", n._onSocketDataBound),
                  n.socket.removeListener("close", n._onSocketCloseBound),
                  n.socket.removeListener("error", n._onSocketErrorBound),
                  (n.socket = null)),
                (n._onSocketConnectBound = null),
                (n._onSocketErrorBound = null),
                (n._onSocketDataBound = null),
                (n._onSocketCloseBound = null),
                l[n.announceUrl] && (l[n.announceUrl].consumers -= 1),
                l[n.announceUrl].consumers > 0)
              )
                return e();
              var s = l[n.announceUrl];
              if (
                (delete l[n.announceUrl],
                s.on("error", o),
                s.once("close", e),
                !n.expectingResponse)
              )
            ...
            (r.prototype._openSocket = function () {
              ...
              (e.destroyed = !1),
                ...
                e.socket
                  ? (l[e.announceUrl].consumers += 1)
                  : ((e.socket = l[e.announceUrl] = new f(e.announceUrl)),
                    (e.socket.consumers = 1),
                    e.socket.once("connect", e._onSocketConnectBound)),
                e.socket.on("data", e._onSocketDataBound),
                e.socket.once("close", e._onSocketCloseBound),
                e.socket.once("error", e._onSocketErrorBound);
            }),
            ...
            (r.prototype._onSocketData = function (e) {
              ...
              if (!t.destroyed) {
                ...
                try {
                  ...
                  return void t.client.emit(
                    "warning",
                    new Error("Invalid tracker response")
                  );
                }
                "announce" === e.action
                  ? t._onAnnounceResponse(e)
                  : "scrape" === e.action
                  ? t._onScrapeResponse(e)
                  : t._onSocketError(
              ...
              if (!e.peer_id || e.peer_id !== t.client._peerIdBinary) {
                ...
                if (
                  (e.offer &&
                    ...
                    (u = t._createPeer()),
                    (u.id = d.binaryToHex(e.peer_id)),
                    u.once("signal", function (n) {
                      var r = {
                        action: "announce",
                        info_hash: t.client._infoHashBinary,
                        peer_id: t.client._peerIdBinary,
                  ...
                  (u = t.peers[c]),
                    u
                      ? ((u.id = d.binaryToHex(e.peer_id)),
                        u.signal(e.answer),
                        t.client.emit("peer", u),
                        clearTimeout(u.trackerTimeout),
                        (u.trackerTimeout = null),
                        delete t.peers[c])
            ...
            (r.prototype._startReconnectTimer = function () {
              var e = this,
                t =
                  ...
                  Math.min(15e3 * Math.pow(2, e.retries), 18e5);
              (e.reconnecting = !0),
            ...
            (r.prototype._generateOffers = function (e, t) {
              ...
              for (var s = 0; s < e; ++s)
                !(function () {
                  ...
                  var t = (r.peers[e] = r._createPeer({ initiator: !0 }));
      ...
      18: [
        ...
        { "./common-node": 21, "safe-buffer": 88, "xtend/mutable": 120 },
      ],
      19: [
        function (e, t, n) {
          (function (e) {
      ...
      20: [
          ...
          (function (n) {
            function r(e, t) {
              ...
              i.call(this),
                ...
                t.nopad
                  ? (this._zeroPadding = !1)
                  : (this._zeroPadding = s(t.zeroPadding, !0)),
                (this._buffered = []),
        ...
        { buffer: 24, defined: 32, inherits: 41, "readable-stream": 82 },
      ],
      21: [function (e, t, n) {}, {}],
      22: [
        function (e, t, n) {
            ...
            (n.alloc = function (e, t, n) {
              ...
              (n.from = function (e, n, r) {
                ...
                if (
                  ...
                  var s = r;
                  if (
                    (void 0 === s && (s = e.byteLength - i), i >= e.byteLength)
                  )
      ...
      24: [
        function (e, t, n) {
          ...
          function f(e) {
            for (
              var t = e.length < 0 ? 0 : 0 | l(e.length), n = r(t), o = 0;
              o < t;
              o += 1
            )
              n[o] = 255 & e[o];
          ...
          function h(e) {
            ...
            if (e) {
              if (V(e) || "length" in e)
                return "number" != typeof e.length || G(e.length) ? r(0) : f(e);
              if ("Buffer" === e.type && Array.isArray(e.data))
                return f(e.data);
            }
            throw new TypeError(
          ...
          function P(e, t, n, r, o) {
            return (
              (t = +t),
              (n >>>= 0),
              o || M(e, t, n, 4, 3.4028234663852886e38, -3.4028234663852886e38),
          ...
          function j(e, t, n, r, o) {
            return (
              ...
              (n >>>= 0),
              o ||
                M(e, t, n, 8, 1.7976931348623157e308, -1.7976931348623157e308),
          ...
          (o.prototype.slice = function (e, t) {
            ...
            (o.prototype.copy = function (e, t, n, r) {
              ...
              else if (i < 1e3) for (o = 0; o < i; ++o) e[o + t] = this[o + n];
      ...
      26: [
        ...
        { "block-stream2": 20, inherits: 41, "readable-stream": 82 },
      ],
      27: [
        function (e, t, n) {
          function r(e, t, n) {
            for (
              var r, i, s, a = 1 / 0, u = 0, c = t.length - 1;
              u <= c &&
              ((r = u + ((c - u) >> 1)),
              (s = t[r] - e),
              s < 0 ? (u = r + 1) : s > 0 && (c = r - 1),
      ...
      29: [
        function (e, t, n) {
          (function (n, r, o) {
                  ...
                  e.map(function (e) {
                    return function (t) {
                      ...
                      if (m(e)) (n.getStream = _(e)), (n.length = e.size);
                        ...
                        (n.getStream = v(e)), (n.length = e.length);
                      else {
                        if (!y(e)) {
                          if ("string" == typeof e) {
                            if ("function" != typeof C.stat)
                              throw new Error(
            ...
            function c(e, t) {
              (t = R(t)),
                C.stat(e, function (n, r) {
                  if (n) return t(n);
                  var o = { length: r.size, path: e };
                  t(null, o);
                });
            }
            function f(e, t, n) {
                ...
                r.WEBTORRENT_ANNOUNCE &&
                  ("string" == typeof r.WEBTORRENT_ANNOUNCE
                    ...
                    : Array.isArray(r.WEBTORRENT_ANNOUNCE) &&
                      (i = i.concat(
                        r.WEBTORRENT_ANNOUNCE.map(function (e) {
                          return [e];
                        })
                      ))),
                void 0 === n.announce &&
                  void 0 === n.announceList &&
                  (i = i.concat(t.exports.announceList)),
                "string" == typeof n.urlList && (n.urlList = [n.urlList]);
              var s = {
                info: { name: n.name },
                "creation date": Math.ceil(
                  (Number(n.creationDate) || Date.now()) / 1e3
                ),
                encoding: "UTF-8",
              };
              0 !== i.length &&
                ((s.announce = i[0][0]), (s["announce-list"] = i)),
      ...
      31: [
        function (e, t, n) {
          ...
          function i(e) {
            ...
            for (
              var t = (e || "").split(/[\s,]+/), r = t.length, o = 0;
              o < r;
              o++
            )
              t[o] &&
          ...
          var r = e("once"),
            ...
            a = function (e, t, n) {
              ...
              var u = e._writableState,
                ...
                g = function () {
                  return (!f || (c && c.ended)) && (!d || (u && u.ended))
                    ? void 0
      ...
      35: [
        function (e, t, n) {
          function r(e, t) {
            ...
            (t = t || {}),
              ...
              (this._size = e.size),
              (this._chunkSize =
                t.chunkSize || Math.max(this._size / 1e3, 204800)),
              (this.reader = new FileReader()),
              this._generateHeaderBlocks(e, t, function (e, t) {
          ...
          i(r, o),
            ...
            (r.prototype._read = function () {
              ...
              if ((r > this._size && (r = this._size), n === this._size))
        ...
        { inherits: 41, "readable-stream": 82, "typedarray-to-buffer": 108 },
      ],
      36: [
        function (e, t, n) {
        ...
        function (e, t, n) {
          (n.read = function (e, t, n, r, o) {
            var i,
              ...
              l = e[t + d];
            for (
              d += h, i = l & ((1 << -f) - 1), l >>= -f, f += a;
              f > 0;
              i = 256 * i + e[t + d], d += h, f -= 8
            );
            for (
              s = i & ((1 << -f) - 1), i >>= -f, f += r;
              f > 0;
              s = 256 * s + e[t + d], d += h, f -= 8
            );
            if (0 === i) i = 1 - c;
            else {
                    ...
                    : ((s = Math.floor(Math.log(t) / Math.LN2)),
                      ...
                      s + d >= f
                        ...
                        : ((a = t * Math.pow(2, d - 1) * Math.pow(2, o)),
                          (s = 0)));
                o >= 8;
                e[n + l] = 255 & a, l += p, a /= 256, o -= 8
              );
              for (
                s = (s << o) | a, c += o;
                c > 0;
                e[n + l] = 255 & s, l += p, s /= 256, c -= 8
              );
              e[n + l - p] |= 128 * m;
            });
        },
      ...
      48: [
            ...
            function r(e) {
              ...
              if (t.xt) {
                (Array.isArray(t.xt) ? t.xt : [t.xt]).forEach(function (e) {
                  if ((o = e.match(/^urn:btih:(.{40})/)))
                    t.infoHash = o[1].toLowerCase();
                  else if ((o = e.match(/^urn:btih:(.{32})/))) {
                    var r = i.decode(o[1]);
              ...
              return (
                Object.keys(e)
                  ...
                  .forEach(function (n, r) {
                    (Array.isArray(e[n]) ? e[n] : [e[n]]).forEach(function (
                      e,
                      o
                    ) {
                      !(r > 0 || o > 0) ||
        ...
        { buffer: 24, "thirty-two": 103, uniq: 110, xtend: 119 },
      ],
      49: [
        function (e, t, n) {
          function r(e, t) {
            ...
            (o.prototype._createSourceBuffer = function () {
              ...
              if (!e.destroyed)
                if (u.isTypeSupported(e._type)) {
                  if (
                    ((e._sourceBuffer = e._mediaSource.addSourceBuffer(
                      e._type
                    )),
                    e._sourceBuffer.addEventListener(
                      "updateend",
                      e._flowHandler
                    ),
                    e._cb)
        ...
        { inherits: 41, "readable-stream": 82, "to-arraybuffer": 105 },
      ],
      50: [
        function (e, t, n) {
          (function (e) {
      ...
      51: [
          ...
          (function (t) {
            ...
            (n.fullBoxes = {}),
              ...
              (n.stsd.decode = function (e, t, n) {
                e = e.slice(t);
                for (
                  var r = e.readUInt32BE(0), o = new Array(r), i = 4, s = 0;
                  s < r;
                  s++
                ) {
              ...
              (n.VisualSampleEntry.encode = function (e, o, i) {
                (o = o
                  ? o.slice(i)
                  : new t(n.VisualSampleEntry.encodingLength(e))),
                  r(o, 0, 6),
              ...
              (n.avcC.decode = function (e, n, r) {
                return (
                  (e = e.slice(n, r)),
                  { mimeCodec: e.toString("hex", 1, 4), buffer: new t(e) }
                );
              }),
              ...
              (n.AudioSampleEntry.encode = function (e, o, i) {
                (o = o
                  ? o.slice(i)
                  : new t(n.AudioSampleEntry.encodingLength(e))),
                  r(o, 0, 6),
                  o.writeUInt16BE(e.dataReferenceIndex || 0, 6),
                  r(o, 8, 16),
              ...
              (n.stco.decode = function (e, t) {
                e = e.slice(t);
                for (
                  var n = e.readUInt32BE(0), r = new Array(n), o = 0;
                  o < n;
                  o++
                )
              ...
              (n.dref.encode = function (e, r, o) {
                ...
                for (var s = 4, a = 0; a < i.length; a++) {
                  ...
                  r.writeUInt32BE(c, s),
                    ...
                    (s += 4),
                    u.buf && (u.buf.copy(r, s), (s += u.buf.length));
                }
              ...
              (n.dref.decode = function (e, t) {
                e = e.slice(t);
                for (
                  var n = e.readUInt32BE(0), r = new Array(n), o = 4, i = 0;
                  i < n;
                  i++
                ) {
              ...
              (n.hdlr.decode = function (e, t, n) {
                return (
                  (e = e.slice(t)),
                  { handlerType: e.toString("ascii", 4, 8), name: l(e, 20, n) }
                );
              }),
        ...
        { "./descriptor": 52, "./index": 53, buffer: 24 },
      ],
      52: [
        function (e, t, n) {
          (function (e) {
      ...
      53: [
                ...
                if (
                  ...
                  s[a].forEach(function (n) {
                    if (5 === n.length) {
                      ...
                      e[n] && (i._encode(e[n], t, c), (c += i.encode.bytes));
                  }),
                    e.otherBoxes &&
              ...
              (i.decodeWithoutHeaders = function (e, n, r, a) {
                ...
                if (s[u]) {
                  ...
                  for (var f = s[u], d = r; a - d >= 8; ) {
                    ...
                    if (((d += h.length), f.indexOf(h.type) >= 0))
                      c[h.type] = h;
        ...
        { "./boxes": 51, buffer: 24, uint64be: 109 },
      ],
      54: [
        function (e, t, n) {
          (function (n) {
              ...
              (r.prototype._readBox = function () {
                function e(r, o) {
                  t._buffer(r, function (r) {
                    ...
                    "number" == typeof i
                      ? e(i - o.length, o)
                      : (t._pending++, (t._headers = i), t.emit("box", i));
                  });
                }
                var t = this;
                e(8);
          ...
          (function (n, r) {
            ...
            (t.exports = i),
              ...
              (i.prototype.box = function (e, t) {
                ...
                var i;
                if (
                  (e.encodeBufferLen && (i = new r(e.encodeBufferLen)),
                  e.stream)
                )
                  (e.buffer = null),
                    (i = c.encode(e, i)),
      ...
      58: [
          ...
          i(r, s.Readable),
            ...
            (r.prototype._next = function () {
              ...
              if (((e._current = null), "function" == typeof e._queue))
                ...
                var t = e._queue.shift();
                "function" == typeof t &&
                  ((t = o(t())), e._attachErrorListener(t)),
                  e._gotNextStream(t);
              }
            }),
        ...
        { inherits: 41, "readable-stream": 82 },
      ],
      59: [
        function (e, t, n) {
          function r(e, t) {
      ...
      61: [
          ...
          (function (n) {
            function r(e) {
              n.isBuffer(e) && (e = u.decode(e)),
                ...
                e.info.files
                  ? e.info.files.forEach(function (e) {
              ...
              (t.info = e.info),
                ...
                (t.announce = []),
                e["announce-list"] && e["announce-list"].length
                  ? e["announce-list"].forEach(function (e) {
                      e.forEach(function (e) {
                        t.announce.push(e.toString());
                      });
                    })
                  : e.announce && t.announce.push(e.announce.toString()),
                n.isBuffer(e["url-list"]) &&
                  (e["url-list"] =
                    e["url-list"].length > 0 ? [e["url-list"]] : []),
            ...
            function o(e) {
              var t = { info: e.info };
              return (
                (t["announce-list"] = (e.announce || []).map(function (e) {
                  return (
                    t.announce || (t.announce = e), (e = new n(e, "utf8")), [e]
                  );
                })),
                (t["url-list"] = e.urlList || []),
                e.created &&
                  (t["creation date"] = (e.created.getTime() / 1e3) | 0),
        ...
        { bencode: 11, buffer: 24, path: 63, "simple-sha1": 92, uniq: 110 },
      ],
      62: [
        function (e, t, n) {
          (function (n, r) {
            ...
            function i(e, t) {
              ...
              i && i.infoHash
                ...
                ? a(e, function (e, n) {
                    if (e)
                      return t(
                        new Error("Error converting Blob: " + e.message)
                      );
                    r(n);
                  })
                : "function" == typeof c && /^https?:/.test(e)
                ? c.concat(
                    {
                      url: e,
                      timeout: 3e4,
                    ...
                    function (e, n, o) {
                      if (e)
                        return t(
                          new Error("Error downloading torrent: " + e.message)
                        );
                      r(o);
                    }
                  )
                : "function" == typeof u.readFile && "string" == typeof e
      ...
      64: [
        function (e, t, n) {
          for (
            var r = e("closest-to"), o = Math.pow(2, 10), i = 13, s = [];
            i++ < 22;
      ...
      67: [
        ...
        { "end-of-stream": 33, fs: 21, once: 60 },
      ],
      68: [
        function (t, n, r) {
          (function (t) {
            !(function (o) {
              ...
              function p(e) {
                var t,
                  ...
                  b = [];
                for (
                  e = u(e), g = e.length, t = C, n = 0, s = A, a = 0;
                  a < g;
                  ++a
                )
                ...
                for (r = o = b.length, o && b.push(T); r < g; ) {
                  ...
                  for (
                    ...
                    if (
                      ((m = e[a]), m < t && ++n > E && i("overflow"), m == t)
                    ) {
                      for (
                        f = n, l = k;
                        (p = l <= s ? x : l >= s + S ? S : l - s), !(f < p);
                        l += k
                      )
                        (v = f - p),
                          (_ = k - p),
            ...
            (r.prototype._write = function (e, t, n) {
              for (var r = this, o = !0; ; ) {
                ...
                if (0 === r._queue.length)
                  return (r._buffer = e), void (r._cb = n);
                r._buffer = null;
                var i = r._queue[0],
      ...
      76: [
        ...
        { "./_stream_transform": 78, "core-util-is": 28, inherits: 41 },
      ],
      77: [
        function (e, t, n) {
          (function (n) {
            ...
            function i(t) {
              if (((A = A || e("./_stream_duplex")), !(this instanceof i)))
                return new i(t);
            ...
            function c(e, t) {
              return e <= 0 || (0 === t.length && t.ended)
                ...
                ? t.flowing && t.length
                  ...
                  : t.length
                : (e > t.highWaterMark && (t.highWaterMark = u(e)),
                  e <= t.length
                    ? e
                    : t.ended
                    ? t.length
            ...
            function m(e, t) {
              for (
                ...
                (j("maybeReadMore read 0"), e.read(0), n !== t.length);
            ...
            (i.prototype.read = function (e) {
              ...
              if (
                ...
                return (
                  j("read: emitReadable", t.length, t.ended),
              ...
              j("need readable", r),
                (0 === t.length || t.length - e < t.highWaterMark) &&
                  ((r = !0), j("length less than watermark", r)),
                t.ended || t.reading
                  ? ((r = !1), j("reading or ended", r))
                  : r &&
                    (j("do read"),
                    (t.reading = !0),
                    (t.sync = !0),
              ...
              (i.prototype.pipe = function (e, t) {
                ...
                function a(t) {
                  j("ondata"),
                    ...
                    !1 !== e.write(t) ||
                      v ||
                      (((1 === l.pipesCount && l.pipes === e) ||
                        (l.pipesCount > 1 && -1 !== B(l.pipes, e))) &&
                        !_ &&
                        (j(
                ...
                (l.pipesCount += 1),
                  j("pipe count=%d opts=%j", l.pipesCount, t);
                var p =
                ...
                return (
                  ...
                  e.once("finish", f),
                  e.emit("pipe", h),
                  l.flowing || (j("pipe resume"), h.resume()),
                  e
                );
              }),
              ...
              (i.prototype.on = function (e, t) {
                ...
                if ("data" === e)
                  ...
                  r.endEmitted ||
                    ...
                    (r.emittedReadable = !1),
                    r.reading ? r.length && h(this) : C(y, this));
                }
                return n;
              }),
              ...
              (i.prototype.resume = function () {
                ...
                return (
                  e.flowing || (j("resume"), (e.flowing = !0), _(this, e)), this
                );
              }),
              (i.prototype.pause = function () {
                return (
                  j("call pause flowing=%j", this._readableState.flowing),
      ...
      78: [
        ...
        { "./_stream_duplex": 75, "core-util-is": 28, inherits: 41 },
      ],
      79: [
        function (e, t, n) {
          (function (n) {
            ...
            function s(t) {
              if (
                ((k = k || e("./_stream_duplex")),
                !(L.call(s, this) || this instanceof k))
              )
                return new s(t);
            ...
            function f(e, t, n, r, i, s) {
              ...
              if ((u || (t.needDrain = !0), t.writing || t.corked)) {
                ...
                (t.lastBufferedRequest = new o(r, i, s)),
                  f
              ...
              if (e._writev && n && n.next) {
                ...
                for (; n; ) {
                  var a = n.chunk,
                    ...
                    c = n.callback;
                  if (
                    (d(e, t, !1, t.objectMode ? 1 : a.length, a, u, c),
                    (n = n.next),
                    t.writing)
                  )
                    break;
            ...
            function b(e, t) {
              ...
              return (
                n &&
                  (0 === t.pendingcb
                    ? (v(e, t), (t.finished = !0), e.emit("finish"))
                    : v(e, t)),
                n
              );
            }
            function w(e, t, n) {
              (t.ending = !0),
                b(e, t),
                n && (t.finished ? x(n) : e.once("finish", n)),
                (t.ended = !0),
                (e.writable = !1);
            }
            function E(e) {
            ...
            I.inherits = e("inherits");
            var B = { deprecate: e("util-deprecate") },
            ...
            "function" == typeof Function.prototype[Symbol.hasInstance]
              ? ((L = Function.prototype[Symbol.hasInstance]),
                Object.defineProperty(s, Symbol.hasInstance, {
                  value: function (e) {
                    return (
                      !!L.call(this, e) || (e && e._writableState instanceof i)
                    );
                  },
                }))
              : (L = function (e) {
              ...
              (s.prototype.write = function (e, t, n) {
                ...
                return (
                  ...
                  o.ended
                    ? a(this, n)
                    : (s || u(this, o, e, n)) &&
                      (o.pendingcb++, (i = f(this, o, s, e, t, n))),
                  i
                );
              }),
            ...
            function a() {
              (p = t("iframe")),
                s(e, function (e, t) {
                  if (e) return c(e);
                  (p.src = t),
                    ".pdf" !== _ && (p.sandbox = "allow-forms allow-scripts"),
                    r(null, p);
                });
            }
            function c(t) {
              ...
              ? (function () {
                  function r() {
                    f("Use MediaSource API for " + e.name),
                      ...
                      p.addEventListener("loadstart", o),
                      p.addEventListener("canplay", i);
                    var t = new h(p),
                  ...
                  function d(e) {
                    f(
                      ...
                      p.removeEventListener("canplay", i),
                      r();
                  }
                  function l(t) {
                    if (
                  ...
                  function v() {
                    p ||
                      ((p = t(b)),
                      p.addEventListener("progress", function () {
                        k = p.currentTime;
                      }));
                  }
        ...
        function (e, t, n) {
          (function (e) {
            t.exports = function (t, n, r) {
              ...
              Array.isArray(t)
                ? ((s = []), (u = a = t.length))
                : ((c = Object.keys(t)), (s = {}), (u = a = c.length));
              var h = n;
              u
                ? c
                  ? c.some(function (e, r) {
          ...
          (function (e) {
            !(function () {
              function n(e) {
                  ...
                  var t = { fill: 0 },
                    ...
                    u = function (e, t, n, r, o) {
                      ...
                      if (!(r < u + a)) {
                        for (i = 4 - a; i < c; i = (i + 4) | 0)
                          t[(o + i) >> 2] =
                            (s.charCodeAt(n + i) << 24) |
                            (s.charCodeAt(n + i + 1) << 16) |
                            (s.charCodeAt(n + i + 2) << 8) |
                            s.charCodeAt(n + i + 3);
                        switch (u) {
                          case 3:
                    ...
                    f = function (e, t, n, r, i) {
                      var s,
                        ...
                        f = r - c,
                        d = new Uint8Array(
                          o.readAsArrayBuffer(a.slice(n, n + r))
                        );
                      switch (u) {
                        case 0:
                          e[i] = d[3];
                ...
                !(function (e) {
                  ...
                  (t.offset = 0),
                    ...
                    (t.heap = new ArrayBuffer(m(t.padMaxChunkLen + 320 + 20))),
                ...
                (this.digest = this.digestFromString = this.digestFromBuffer = this.digestFromArrayBuffer = function (
                  ...
                  (this.append = function (e) {
                    ...
                    for (t.offset += o; r < o; )
                      (n = Math.min(o - r, t.maxChunkLen - i)),
                        _(e, r, n, i),
                        (i += n),
                        (r += n),
                        i === t.maxChunkLen &&
                          (t.core.hash(t.maxChunkLen, t.padMaxChunkLen),
                          (i = 0));
                    return this;
                  }),
                  ...
                  (this.setState = function (e) {
                    if (((t.offset = e.offset), 20 === e.heap.byteLength)) {
                      new Int32Array(t.heap, t.padMaxChunkLen + 320, 5).set(
              ...
              if (
                ...
                void 0 !== t
                  ? (t.exports = n)
                  : "undefined" != typeof window && (window.Rusha = n),
                ...
                self.onmessage = function (e) {
                  ...
                  try {
                    (t = i.digest(n)),
                      self.postMessage({ id: e.data.id, hash: t });
                  } catch (t) {
      ...
      90: [
        function (e, t, n) {
          (function (n) {
            function r(e, t) {
              (e = "string" == typeof e ? { url: e } : Object.assign({}, e)),
                (t = u(t)),
                e.url && o(e),
              ...
              var i;
              e.form &&
                (i = "string" == typeof e.form ? e.form : c.stringify(e.form)),
                e.body && (i = e.json ? JSON.stringify(e.body) : e.body),
                e.json && (e.headers.accept = "application/json"),
                e.json && i && (e.headers["content-type"] = "application/json"),
                e.form &&
                  (e.headers["content-type"] =
                    "application/x-www-form-urlencoded"),
                i && (e.headers["content-length"] = n.byteLength(i)),
                delete e.body,
                delete e.form,
                i && !e.method && (e.method = "POST"),
                e.method && (e.method = e.method.toUpperCase()),
                Object.keys(e.headers).some(function (e) {
              ...
              var d = "https:" === e.protocol ? a : s,
                h = d.request(e, function (n) {
                  if (
                    n.statusCode >= 300 &&
                    n.statusCode < 400 &&
                    "location" in n.headers
                  )
                    return (
                      (e.url = n.headers.location),
                      n.resume(),
                      void (e.maxRedirects > 0
                        ? ((e.maxRedirects -= 1), r(e, t))
        ...
        function (e, t, n) {
          (function (n) {
            function r(e) {
              ...
              if (
                ((t._id = u(4).toString("hex").slice(0, 7)),
            ...
            a(r, c.Duplex),
              ...
              (r.prototype.send = function (e) {
                var t = this;
                t._isWrtc && n.isBuffer(e) && (e = new Uint8Array(e)),
                  t._channel.send(e);
              }),
              (r.prototype.destroy = function (e) {
                this._destroy(null, e);
              ...
              (r.prototype._write = function (e, t, n) {
                ...
                if (r.connected) {
                  ...
                  r._channel.bufferedAmount > 65536
                    ? (r._debug(
                  ...
                  e._pc.createOffer(
                    function (t) {
                      ...
                      e.destroyed ||
                        ...
                        e._pc.setLocalDescription(t, n, r));
                    },
                    function (t) {
                      e._destroy(t);
                    },
              ...
              (r.prototype._onIceStateChange = function () {
                ...
                if (!e.destroyed) {
                  ...
                  e._debug(
                    ...
                    e.emit("iceStateChange", t, n),
                    ("connected" !== t && "completed" !== t) ||
              ...
              (r.prototype._onIceCandidate = function (e) {
                ...
                t.destroyed ||
                  (e.candidate && t.trickle
                    ...
                    : e.candidate ||
                      ((t._iceComplete = !0), t.emit("_iceComplete")));
              }),
              ...
              (r.prototype._onAddStream = function (e) {
                var t = this;
                t.destroyed ||
                  (t._debug("on add stream"), t.emit("stream", e.stream));
              }),
              (r.prototype._onTrack = function (e) {
                ...
                if (!t.destroyed) {
                  ...
                  -1 === t._previousStreams.indexOf(n) &&
                    (t._previousStreams.push(n),
              ...
              (r.prototype._transformConstraints = function (e) {
                ...
                if ((e.mandatory || e.optional) && !t._isChromium) {
                  ...
                  return (
                    void 0 !== n.OfferToReceiveVideo &&
                      ((n.offerToReceiveVideo = n.OfferToReceiveVideo),
                      delete n.OfferToReceiveVideo),
                    void 0 !== n.OfferToReceiveAudio &&
                      ((n.offerToReceiveAudio = n.OfferToReceiveAudio),
                      delete n.OfferToReceiveAudio),
                    n
                  );
                }
                return e.mandatory || e.optional || !t._isChromium
                  ? e
          ...
          (function (n) {
            function r(e) {
              ...
              if (
                ...
                try {
                  t._ws =
                    "function" == typeof c ? new f(e.url, e) : new f(e.url);
                } catch (e) {
            ...
            s(r, u.Duplex),
              ...
              (r.prototype._write = function (e, t, n) {
                ...
                if (this.connected) {
                  ...
                  "function" != typeof c && this._ws.bufferedAmount > 65536
                    ? (this._debug(
                        "start backpressure: bufferedAmount %d",
      ...
      96: [
        function (e, t, n) {
          (function (e) {
            ...
            (n.arraybuffer = n.fetch || (s && r("arraybuffer"))),
              (n.msstream = !n.fetch && a && r("ms-stream")),
              (n.mozchunkedarraybuffer =
                !n.fetch && s && r("moz-chunked-arraybuffer")),
              (n.overrideMimeType =
          ...
          (function (n, r, o) {
            ...
            var a = e("./capability"),
              ...
              p = (t.exports = function (e) {
                ...
                var n,
                  r = !0;
                if ("disable-fetch" === e.mode || "timeout" in e)
                  (r = !1), (n = !0);
            ...
            u(p, f.Writable),
              (p.prototype.setHeader = function (e, t) {
                var n = this,
                  r = e.toLowerCase();
                -1 === m.indexOf(r) && (n._headers[r] = { name: e, value: t });
              }),
              ...
              (p.prototype._connect = function () {
                var e = this;
                e._destroyed ||
                  ((e._response = new h(e._xhr, e._fetchResponse, e._mode)),
              ...
              (c.prototype._onXHRProgress = function () {
                ...
                switch (e._mode) {
                  ...
                  case "moz-chunked-arraybuffer":
                    if (((n = t.response), t.readyState !== u.LOADING || !n))
                      break;
        ...
        function (e, t, n) {
          ...
          t.exports = function e(t, n, o) {
            ...
            t.on("data", function (e) {
              ...
              .on("end", function () {
                var e = n ? new Blob(i, { type: n }) : new Blob(i);
                o(null, e);
              })
              .on("error", o);
          };
        ...
        function (e, t, n) {
          (function (e) {
            ...
            (n.encode = function (n) {
              ...
              for (
                var r = 0, o = 0, i = 0, s = 0, a = new e(8 * t(n));
                r < n.length;
                ...
                i > 3
                  ? ((s = u & (255 >> i)),
                    ...
                    (s =
                      (s << i) |
                      ((r + 1 < n.length ? n[r + 1] : 0) >> (8 - i))),
                    r++)
                  : ((s = (u >> (8 - (i + 5))) & 31),
                    0 == (i = (i + 5) % 8) && r++),
                  (a[o] = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567".charCodeAt(s)),
                  o++;
              }
              for (r = o; r < a.length; r++) a[r] = 61;
              return a;
            }),
              (n.decode = function (t) {
                var n,
                ...
                for (
                  var a = new e(Math.ceil((5 * t.length) / 8)), u = 0;
                  u < t.length && 61 !== t[u];
                  u++
                ) {
                  var c = t[u] - 48;
            ...
            function r(e) {
              ...
              (o.peerId =
                ...
                (o._onDHTPeer = function (e, t) {
                  t.toString("hex") === o.infoHash &&
                    o.emit("peer", e.host + ":" + e.port, "dht");
                }),
                ...
                !1 === e.tracker
                  ...
                  ? ((o._trackerOpts = a(e.tracker)),
                    (o.tracker = o._createTracker()))
                  : (o.tracker = o._createTracker()),
                !1 === e.dht || "function" != typeof i
                  ...
                  ? (o.dht = t(e.dhtPort, e.dht))
                  : (o.dht = t(e.dhtPort)),
                o.dht && (o.dht.on("peer", o._onDHTPeer), o._dhtAnnounce());
            }
            t.exports = r;
            ...
            u(r, s),
              ...
              (r.prototype.destroy = function (e) {
                ...
                if (!t.destroyed) {
                  ...
                  t.tracker &&
                    ...
                    t._internalDHT &&
                      (t.dht.removeListener("warning", t._onWarning),
              ...
              (r.prototype._dhtAnnounce = function () {
                function e() {
                  return (
                    t._intervalMs +
                    Math.floor((Math.random() * t._intervalMs) / 5)
                  );
                }
                var t = this;
                t._dhtAnnouncing ||
                  ...
                  t.dht.announce(t.infoHash, t._port, function (n) {
                    (t._dhtAnnouncing = !1),
                      ...
                      t.emit("dhtAnnounce"),
                      t.destroyed ||
                        ((t._dhtTimeout = setTimeout(function () {
                          t._dhtAnnounce();
                        }, e())),
                ...
                for (var o = t.length, i = Math.ceil(o / r), s = 0; s < i; s++)
                  if (!this._buffer[e + s]) {
                    ...
                    this._buffered++,
                      ...
                      -1 === this.sources.indexOf(n) && this.sources.push(n);
                  }
            ...
            (n.encodingLength = function () {
              ...
              (n.decode = function (t, n) {
                return (
                  ...
                  t || (t = new e(4)),
                  n || (n = 0),
                  4294967295 * t.readUInt32BE(n) + t.readUInt32BE(n + 4)
                );
              }),
              (n.encode.bytes = 8),
              (n.decode.bytes = 8);
      ...
      112: [
        function (e, t, n) {
          ...
          (r.prototype.parse = function (e, t, n) {
            ...
            if (!v[d] && (p || (d && !b[d]))) {
              ...
              var S, I;
              (I = -1 === E ? s.lastIndexOf("@") : s.lastIndexOf("@", E)),
                -1 !== I &&
                  ((S = s.slice(0, I)),
                  (s = s.slice(I + 1)),
              ...
              if (!B)
                for (
                  var A = this.hostname.split(/\./), k = 0, C = A.length;
                  k < C;
                  k++
                ) {
                  var T = A[k];
              ...
              this.hostname.length > 255
                ...
                B || (this.hostname = u.toASCII(this.hostname));
            ...
            if (
              (-1 !== W
                ...
                : t && ((this.search = ""), (this.query = {})),
              s && (this.pathname = s),
              b[l] && this.hostname && !this.pathname && (this.pathname = "/"),
              ...
              for (
                ...
                (I = k[C]),
                  "." === I
                    ...
                    ? (k.splice(C, 1), A++)
                    : A && (k.splice(C, 1), A--);
              if (!w && !E) for (; A--; A) k.unshift("..");
              !w ||
                "" === k[0] ||
                (k[0] && "/" === k[0].charAt(0)) ||
                k.unshift(""),
                B && "/" !== k.join("/").substr(-1) && k.push("");
        ...
        { "./util": 113, punycode: 68, querystring: 71 },
      ],
      113: [
        function (e, t, n) {
          "use strict";
          ...
          t.exports = function (e) {
            ...
            return (
                  ...
                  ? e.metadata_size
                    ? "number" != typeof e.metadata_size ||
                      ...
                      : ((this._metadataSize = e.metadata_size),
                        (this._numPieces = Math.ceil(
                          this._metadataSize / 16384
                        )),
                        (this._remainingRejects = 2 * this._numPieces),
                        void (this._fetching && this._requestPieces()))
                    : this.emit(
                        "warning",
              ...
              (t.prototype.setMetadata = function (e) {
                ...
                return (
                  (!this._infoHash || this._infoHash === c.sync(e)) &&
                  (this.cancel(),
                  (this.metadata = e),
                  ...
                  this.emit(
                    "metadata",
                    r.encode({ info: r.decode(this.metadata) })
                  ),
                  !0)
                );
              }),
          ...
          (function (n) {
            ...
            (t.exports = r),
              ...
              (o.prototype.inc = function () {
                var e = this;
                e._offset++,
                  e._offset >= e._entries[e._index][e._countName] &&
                    (e._index++, (e._offset = 0)),
              ...
              (r.prototype._processMoov = function (e) {
                ...
                var U = f.encode(t._ftyp),
                  R = t._tracks.map(function (e) {
                    ...
                    return { mime: e.mime, init: n.concat([U, t]) };
                  });
                t.emit("ready", R);
              }),
              (r.prototype.seek = function (e) {
                ...
                t._fileStream &&
                  (t._fileStream.destroy(), (t._fileStream = null));
                var n = -1;
                if (
                  (t._tracks.map(function (r, o) {
                    function i(e) {
                      s.destroyed ||
                        s.box(e.moof, function (n) {
                          if (n) return t.emit("error", n);
                          if (!s.destroyed) {
                            r.inStream.slice(e.ranges).pipe(
                              s.mediaData(e.length, function (e) {
                  ...
                  t._tracks.forEach(function (e) {
                    (e.inStream = new d(n, { highWaterMark: 1e7 })),
                      r.pipe(e.inStream);
                  });
                }
            ...
            (r.prototype._generateFragment = function (e, t) {
              var n,
                ...
                o = r._tracks[e];
              if (
                (n = void 0 !== t ? r._findSampleBefore(e, t) : o.currSample) >=
                o.samples.length
              )
                return null;
              for (
                var i = o.samples[n].dts, s = 0, a = [], u = n;
                u < o.samples.length;
                u++
              ) {
                var c = o.samples[u];
                ...
                s += c.size;
                var f = a.length - 1;
                f < 0 || a[f].end !== c.offset
                  ? a.push({ start: c.offset, end: c.offset + c.size })
                  : (a[f].end += c.size);
              }
              return (
                (o.currSample = u),
                { moof: r._generateMoof(e, n, u), ranges: a, length: s }
              );
            }),
              (r.prototype._generateMoof = function (e, t, n) {
                for (
                  var r = this, o = r._tracks[e], i = [], s = t;
                  s < n;
                  s++
                ) {
                  var a = o.samples[s];
                ...
                var u = {
                  ...
                  trafs: [
                    {
                      tfhd: { flags: 131072, trackId: o.trackId },
          ...
          (t.exports = r),
              ...
              (e._muxer = new s(e._file)),
                e._muxer.on("ready", function (t) {
                  (e._tracks = t.map(function (t) {
                    ...
                    (e._waitingFired || "auto" === e._elem.preload) &&
                      e._pump();
                }),
            ...
            (r.prototype._pump = function () {
              ...
              e._tracks.forEach(function (n, r) {
                var o = function () {
                  n.muxed &&
                    (n.muxed.destroy(),
                    (n.mediaSource = e._elemWrapper.createWriteStream(
                      n.mediaSource
                    )),
            ...
            (r.prototype.destroy = function () {
              ...
              e.destroyed ||
                ...
                e._tracks &&
                  e._tracks.forEach(function (e) {
                    e.muxed.destroy();
                  }),
                (e._elem.src = ""));
            });
        },
        { "./mp4-remuxer": 116, mediasource: 49, pump: 67 },
      ],
      118: [
        function (e, t, n) {
          function r(e, t) {
          ...
          t.exports = function e(t, n, r) {
            return void 0 === n
              ...
              : (void 0 === r && (r = "0"),
                (t -= n.toString().length),
                t > 0
                  ? new Array(t + (/\./.test(n) ? 2 : 1)).join(r) + n
                  : n + "");
          };
        },
        {},
          ...
          (function (n, r) {
            function o(e) {
              ...
              h.call(i),
                ...
                "string" == typeof e.peerId
                  ? (i.peerId = e.peerId)
                  : a.isBuffer(e.peerId)
                  ? (i.peerId = e.peerId.toString("hex"))
                  : (i.peerId = a
                      .from(B + b(9).toString("base64"))
                      .toString("hex")),
                (i.peerIdBuffer = a.from(i.peerId, "hex")),
                "string" == typeof e.nodeId
                  ? (i.nodeId = e.nodeId)
                  : a.isBuffer(e.nodeId)
                  ? (i.nodeId = e.nodeId.toString("hex"))
                  : (i.nodeId = b(20).toString("hex")),
                (i.nodeIdBuffer = a.from(i.nodeId, "hex")),
                (i._debugId = i.peerId.toString("hex").substring(0, 7)),
                (i.destroyed = !1),
                (i.listening = !1),
                ...
                i.tracker &&
                  ("object" != typeof i.tracker && (i.tracker = {}),
                  e.rtcConfig &&
                    (console.warn(
                ...
                (i._downloadSpeed = w()),
                (i._uploadSpeed = w()),
                !1 !== e.dht && "function" == typeof d
                  ? ((i.dht = new d(l({ nodeId: i.nodeId }, e.dht))),
                    ...
                    i.dht.listen(i.dhtPort))
                  : (i.dht = !1),
                (i.enableWebSeeds = !1 !== e.webSeeds),
                "function" == typeof m && null != e.blocklist
                  ? m(
                      e.blocklist,
                      {
                        headers: {
                          "user-agent":
                            "WebTorrent/" + S + " (https://webtorrent.io)",
                        },
                      },
                      function (e, n) {
                        if (e)
                          return i.error(
                            "Failed to load blocklist: " + e.message
                          );
                        (i.blocked = n), t();
                      }
                    )
            ...
            p(o, h),
              ...
              Object.defineProperty(o.prototype, "ratio", {
                get: function () {
                  return (
                    this.torrents.reduce(function (e, t) {
                      return e + t.uploaded;
                    }, 0) /
                    (this.torrents.reduce(function (e, t) {
                      return e + t.received;
              ...
              (o.prototype.get = function (e) {
                ...
                if (e instanceof x) {
                  ...
                  if (!i.infoHash)
                    throw new Error("Invalid torrent identifier");
                  for (t = 0; t < o; t++)
                    if (((n = r.torrents[t]), n.infoHash === i.infoHash))
                      return n;
                }
                return null;
              }),
              ...
              (o.prototype.add = function (e, t, n) {
                ...
                function o() {
                  s.destroyed ||
                    ("function" == typeof n && n(a), s.emit("torrent", a));
                }
                function i() {
              ...
              (o.prototype.seed = function (e, t, n) {
                ...
                a._debug("seed"),
                  ...
                  t.createdBy || (t.createdBy = "WebTorrent/" + I);
                var f,
                  d = a.add(null, t, r);
                return (
                  s(e) && (e = Array.prototype.slice.call(e)),
                  Array.isArray(e) || (e = [e]),
                  g(
                    e.map(function (e) {
                      return function (t) {
                    ...
                    function (e, n) {
                      if (!a.destroyed)
                        return e
                          ? d._destroy(e)
                          : void c.parseInput(n, t, function (e, r) {
                              if (!a.destroyed) {
